...
printf  ("%d\n") (f2  (1) (2));
printf  ("%d\n") (f2  (1) (2));
let (f3:(int)->((int)->((int)->(int)))) = (fun (a) (b) (c) -> 
  ((a + b) + c);
) in
let (f3:(int)->((int)->((int)->(int)))) = (fun (a) -> (fun (b) (c) -> 
    ((a + b) + c);
  )) in
...
recursive_function (());;
let tuple = (fun (()) -> 
  let (addt:((int * int))->(int)) = (fun ((a , b)) -> 
  (a + b);
) in
  let (f2:((int * int))->(((int * int))->(int))) = (fun ((a , b)) ((c , d)) -> 
  ((a * b) + (c * d));
) in
  printf ("%d\n") (f2 ((1 , 2)) ((3 , 4)));
  printf  ("%d\n") (f2  ((1 , 2)) ((3 , 4)));
